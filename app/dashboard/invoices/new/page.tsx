...
import { FileText, Plus, Trash2, Loader as Loader2, CircleAlert as AlertCircle, ArrowLeft, User, Calculator, Save, Send } from 'lucide-react';
                      ...
                      {services.map((service) => (
                        <option key={service.id} value={service.id}>
                          ...
                          {service.pricing_type !== 'Fixed' &&
                            ` / ${service.pricing_type === 'Per Hour' ? 'hr' : 'm²'}`}
                        </option>
                      ))}
                    </select>
                  </div>
            ...
            {requireDeposit && (
              <>
                ...
                <div className="flex items-center justify-between p-4 bg-slate-50 rounded-lg">
                  ...
                  <span className="font-mono text-lg text-slate-900">{formatCurrency(balanceDue)}</span>
                </div>
              </>
            )}
