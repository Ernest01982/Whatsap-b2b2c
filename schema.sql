...
-- TABLE: merchants
-- =============================================================================
-- Core business account table linking to Supabase Auth
-- Each merchant has feature flags and Ozow payment credentials
...
-- TABLE: clients
-- =============================================================================
-- Customer records belonging to each merchant
-- Phone number must be unique per merchant (not globally)
...
-- TABLE: services
-- =============================================================================
-- Service catalog with flexible pricing models for quotes/invoices
...
-- =============================================================================
-- Unified document for quotes and invoices with payment tracking
-- Status progression: Draft -> Pending Deposit -> Pending Final -> Paid
...
-- TABLE: invoice_items
-- =============================================================================
-- Line items for quotes/invoices linking to services
...
-- TABLE: events
-- =============================================================================
-- Event management for ticketing functionality
...
-- TABLE: tickets
-- =============================================================================
-- Individual ticket records with QR hash for offline verification
...
-- =============================================================================
-- Utility function to get the merchant_id for the current authenticated user
